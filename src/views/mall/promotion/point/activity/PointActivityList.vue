<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="会员专属" prop="memberOnly">
        <el-select v-model="queryParams.memberOnly" class="!w-240px" clearable placeholder="全部">
          <el-option
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column align="center" label="会员专属" min-width="90" prop="memberOnly">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.INFRA_BOOLEAN_STRING" :value="scope.row.memberOnly" />
        </template>
      </el-table-column>
